// node_modules/.pnpm/tsup@8.3.5_jiti@2.4.1_postcss@8.4.49_tsx@4.19.2_typescript@5.6.3_yaml@2.6.1/node_modules/tsup/assets/esm_shims.js
...
function encodeStr(str) {
  ...
  return path4.posix.normalize(result.join(""));
}
...
function removeQuery(pathe) {
  ...
  if (queryIndex !== -1) {
    return path4.posix.normalize(pathe.slice(0, queryIndex));
  }
  return path4.posix.normalize(pathe);
}
    ...
    farmPlugin.resolve = {
      ...
      async executor(params, context) {
        ...
        if (!isStartsWithSlash(params.source))
          return null;
        const rootAbsolutePath = path5.resolve(
          params.source
        );
