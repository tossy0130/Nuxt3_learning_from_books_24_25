...
function createBuildContext(compiler, compilation, loaderContext) {
  return {
    ...
    addWatchFile(file) {
      compilation.fileDependencies.add((0, import_node_path.resolve)(process.cwd(), file));
    },
    getWatchFiles() {
      ...
      if (emittedFile.source && outFileName) {
        ...
        compilation.emitAsset(
          ...
          new sources.RawSource(
            typeof emittedFile.source === "string" ? emittedFile.source : import_node_buffer.Buffer.from(emittedFile.source)
          )
        );
      }
    }
